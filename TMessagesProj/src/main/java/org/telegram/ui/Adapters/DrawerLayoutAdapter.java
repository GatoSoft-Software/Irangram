...
import com.iranianapp.irangram.R;
...
public class DrawerLayoutAdapter extends BaseAdapter {
    ...
    private int changeApp = 6;

    private int contactsRow = 8;
    private int onlinecontactsRow = 9;
    private int contactChangesRow = 10;
    private int specificcontactRow = 11;
    private int searchByIdRow = 12;

    private int chatCategory = 14;
    private int reportSpam = 15;
    private int cachContolerRow = 16;

    private int themingRow = 18;
    private int themeStoreRow = 19;
    private int offlineThemesRow = 20;
    private int settingsRow = 21;
    private int plusSettingsRow = 22;
    private int channelRow = 24;
    private int InviteFriends = 25;
    private int Allmedia = 26;
    private int AboutUs = 27;
    private int faqRow = 28;
    private int versionRow = 29;
    ...
    public boolean isEnabled(int i) {
        return !( i == 1 || i == 5 || i == 13 || i == 17 || i == 23|| i == 7);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == 0) {
            ...
            if (i == 2) {
                ...
                Drawable anothercell = mContext.getResources().getDrawable(R.drawable.ic_cellphone);
                anothercell.setColorFilter(color, PorterDuff.Mode.SRC_IN);
                actionCell.setTextAndIcon(LocaleController.getString("anotherAppName", R.string.anotherAppName), anothercell);
    ...
    public int getItemViewType(int i) {
        if (i == 0) {
            ...
            return 1;
        } else if (i == 5 ||  i == 13 || i == 17 || i == 23|| i == 7) {
            return 2;
        }
        //new
